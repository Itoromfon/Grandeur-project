const ProductsData = [
  {
      id: 1,
      name: 'Home Automation Management Comfort Kit',
      Basic: {
        images: [
          'assets/img/New-Kits-2/Grandeur smart Basic Home Automation mgt kit a.png',
          'assets/img/New-Kits-2/Grandeur smart Basic Home Automation mgt kit b.png',
        ],
